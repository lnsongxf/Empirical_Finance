...
main_data=pd.read_stata(r"matchid_final_test.dta")
...
import pickle
filepath="results3/Q_4_pop_emp_share_no_school_gdp_pop_emp2000weight.pkl"
with open(filepath, 'rb') as f:
    file_path_emp2000weight = pickle.load(f)
res=file_path_emp2000weight.fit()
