...
regression_fun <- function(start_it){
    ...
    library(dplyr)
    # Read Data
    df<-read_dta("matchid_final_test.dta")
    ...
    df<-df[df[name_v1]==df[cname_v1]|df$treated==1,]
    ...
    df<-transform(df,NB=unlist(tapply(treated,matchid,index)))
    #drop if NB>90
    df<-df[!df["NB"]>90,]
    ...
    file_path_noweight<-paste("results3_R/Q_",iteration_list[[start_it]][1],"_",
                     ...
                     iteration_list[[start_it]][4],"_",iteration_list[[start_it]][5],"_noweight",sep="")
    file_path_emp2000weight<-paste("results3_R/Q_",iteration_list[[start_it]][1],"_",
                              iteration_list[[start_it]][2],"_",iteration_list[[start_it]][3],"_",
                              iteration_list[[start_it]][4],"_",iteration_list[[start_it]][5],"_emp2000weight",sep="")
    file_path_pop2000weight<-paste("results3_R/Q_",iteration_list[[start_it]][1],"_",
                              iteration_list[[start_it]][2],"_",iteration_list[[start_it]][3],"_",
                              iteration_list[[start_it]][4],"_",iteration_list[[start_it]][5],"_pop2000weight",sep="")
